    ...
    <section class="header">
        ...
        <div class="hero">
            <div class="hero-left">
                ...
                <p data-aos="fade-up" data-aos-duration="1000">Melangkah Bersama Menuju Kehidupan Lebih Berkualitas dan Sejuk. Temukan Solusi Terbaik Anda dalam
                ...
                <div class="hero-button" data-aos="fade-up" data-aos-duration="1000">
                    <a href="https://tokopedia.link/bjYCI0x4QHb" target="_blank">
                        <button href="https://tokopedia.link/bjYCI0x4QHb" class="hero-order-btn">Order Sekarang <svg width="29" height="25" viewBox="0 0 29 25"
    ...
    <section class="produk" id="produk">
        ...
        <div class="card-container" id="all-product">
            ...
            @foreach ($product as $item)
                <div class="card-produk" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="{{ $delay }}"">
