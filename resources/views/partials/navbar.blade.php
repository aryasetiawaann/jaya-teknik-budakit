<nav>
    ...
    <div class="nav-right">
        <ul>
            <li><a href="http://localhost:8000/#">Beranda</a></li>
            <li><a href="http://localhost:8000/#benefit">Benefit</a></li>
            <li><a href="http://localhost:8000/#produk">Produk</a></li>
            <li><a href="http://localhost:8000/#kontak">Kontak</a></li>
        </ul>
    </div>
...
const bar = document.querySelector(".nav-right ul");
